...
// On stocke ici dans le config.json  les informations de connexion à notre base
// Ce qui nous permet d'éviter de les écrires dans nos fichiers de code et centraliser ces informations de manière sécurisé à un seul endroit 
...
try {
    ...
    $login = $config["db_user"]; // login
    $password = $config["db_password"];; // mdp
    $options = array(
