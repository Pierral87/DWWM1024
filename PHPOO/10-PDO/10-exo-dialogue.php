...
// Ici ok, on manipule uniquement la table commentaire et on réinsère dans la table commentaire, mais il faut bien comprendre que lorsqu'une injection est possible sur votre site, alors, l'intégralité du système et des données sont compromises ! 

// Meme si ici la requête d'origine concerne la table commentaire, rien ne nous empêche d'intéragir sur une table user, pour récupérer l'entièreté des infos des users, l'insérer dans un .txt, l'insérer dans la table commentaire, pour la rendre visible et ainsi récupérer les données privées des users....
