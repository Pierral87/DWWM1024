 ...
 */
final class Version20250224092301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE emprunt (id INT AUTO_INCREMENT NOT NULL, livre_id INT NOT NULL, abonne_id INT NOT NULL, date_emprunt DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_retour DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_364071D737D925CB (livre_id), INDEX IDX_364071D7C325A696 (abonne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
