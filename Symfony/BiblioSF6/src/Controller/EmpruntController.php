...
final class EmpruntController extends AbstractController
{
    ...
    {
        $emprunt = new Emprunt();
        // Ici je fais appel au setter de DateEmprunt pour lui définir une valeur par défaut, à savoir, la date d'aujourd'hui !
        // Logiquement, lorsqu'il y a saisie d'un emprunt, ce devrait toujours être la date d'aujourd'hui
